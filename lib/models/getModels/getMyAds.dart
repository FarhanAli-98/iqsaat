...
//
//     final GetMyAds = GetMyAdsFromJson(jsonString);

import 'dart:convert';

GetMyAds welcomeFromJson(String str) => GetMyAds.fromJson(json.decode(str));

String welcomeToJson(GetMyAds data) => json.encode(data.toJson());
...
class GetMyAds {
    ...
    factory GetMyAds.fromJson(Map<String, dynamic> json) => GetMyAds(
