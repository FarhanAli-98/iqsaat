...
class HomeAppiances extends StatefulWidget {
  HomeAppiances({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _HomeAppiancesState createState() => _HomeAppiancesState();
}

double width, height;

class _HomeAppiancesState extends State<HomeAppiances> {
  @override
  Widget build(BuildContext context) {
      ...
      return SingleChildScrollView(
        child: Container(
          ...
          children: [
            Categories(indexs:1),
            SizedBox(height: 10),
            HomeScreenRow(text: 'HomeAppiances '),
            Container(
              height: height,
              width: width,
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: appBarUserSide(context, "HomeAppiances"),
        body: _body(),
      ),
    );
  }
